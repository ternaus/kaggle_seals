...
# all aug until ~30
config.AUGMENTATION.PARAMS = {"geom_prob": 0.5,
                              # "angle": (0, 360),
                              # "shear": (0, 0),
                              "scale": (0.5, 1, 2),
                              "flip_h": 1,
                              ...
                              "crop_size": (1000, 1000),
                              "iou_threshold": 0.6}
# """# 0 90 180 270 until 50
"""
config.AUGMENTATION.PARAMS = {"geom_prob": 1,
                              "angle": (0, 360),
                              "shear": (0, 0),
                              "scale": (1, 1, 1),
                              "flip_h": 1,
...
config.SCALES = [(1000, 1000)]  # first is scale (the shorter side); second is max size
